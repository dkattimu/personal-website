...
let cssClsVisibleWide =
  'hidden bg-blue-500 items-center rounded text-white mx-0 my-2 px-2 h-8 w-auto md:flex';
let cssClsVisibleNarrow =
  'visible bg-blue-500 items-center rounded text-white mx-0 m-0 px-2 h-8 w-auto min-w-24 md:hidden';
