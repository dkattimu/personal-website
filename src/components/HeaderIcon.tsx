...
let svg_class = "text-green-100 size-6"

let HeaderIcon = ({option, descr, style=svg_class}: IconProps) =>{ 
    if (option=="home"){
    return (
      <div className="flex"> 
...
let ThemeToggle = ({descr="Dark/Light THeme", style=svg_class}: IconProps) =>{
  return (
    <div>
