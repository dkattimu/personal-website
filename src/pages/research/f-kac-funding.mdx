...
abstract: In this short note, we revisiti the idea of dividend paying stocks, clarifying the option pricing formulation for total and price return indices.
